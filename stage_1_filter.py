...
# --- 1. CONFIGURATION ---
CDE_CATALOG_PATH = os.getenv('CDE_CATALOG', 'cdeCatalogs/cdeCatalog.csv')
MAPPING_FILE_PATH = 'permissible_values_map.csv'
...
def run_stage_1_processing(df: pd.DataFrame, mapping_dict: dict) -> (pd.DataFrame, list, dict):
    """
